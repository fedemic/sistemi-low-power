...
\vspace{3cm}
\centerline{\Huge\sf Sistemi elettronici a basso consumo}
\bigskip
\centerline{\LARGE\bfseries\sf Relazioni di laboratorio}
\vspace{4cm}
...
%
\centerline{\Large Autori: codice gruppo}
\vspace{2cm}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% AUTHORS
...
%
\centerline{Simone Favero, Federico Micelli, Francesca Spanna}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{2cm}
\centerline{\today}
