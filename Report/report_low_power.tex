...
\begin{itemize}
	...
	$A(Y) = 0.5$ 
\end{itemize} 
Simulando il testbench fornito tramite ModelSim, è possibile ottenere un file 
...
\begin{itemize}
	...
	\textcolor{red}{non dovrebbe essere: Cout = (A AND B) OR (A AND Cin) OR (B AND Cin) OR (A AND B AND Cin) ?}\\
\end{itemize}
...
\begin{center}
\begin{listato}
	\centerline{\lstinputlisting{./code/Lab_2/fsm1.txt}}
\end{listato}
\end{center}
