...
\\\\
E' inoltre possibile approfondire l'analisi di potenza considerando i contributi interni dei singoli moduli. In particolare, vengono messi in luce i contributi dei nodi interni ai singoli full adder, sempre suddivisi nei tre contributi precedentemente descritti.
Per comprendere l'origine del consumo inferiore del FA8, quest'ultimo è stato analizzato come cella ed è stato confrontato con il FA1.
...
\\
E' possibile ottenere informazioni aggiuntive sul calcolo della potenza di switching con un'analisi di tipo verbose. In tale analisi sono riportati i contributi capacitivi necessari al calcolo della switching power, espressi nodo per nodo.
\\\\
\begin{center}
	\begin{tabular}{|c|c|c|c|c|}
	\multicolumn{5}{c}{FA(1) }\\
...
assumono entrambi un valore logico basso, portando quindi l'uscita a 0. Tale comportamento atteso è mostrato nella seguente figura.
\\\\
...
\\\\
\centerline{\includegraphics[width=8cm]{./img/Lab_1/Es_5/Contatore.png}}
\\\\
...
di un contatore. 
Tale glitch avviene successivamente alla commutazione
