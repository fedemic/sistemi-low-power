...
\end{center}
\vspace{0.3cm}
Si nota come all'aumentare della capacità di carico si abbia un incremento \textcolor{blue}{non lineare} dei ritardi temporali. Come conseguenza si ha infatti un progressivo incremento delle costanti di tempo per le varie transizioni.
\\\\
...
\\\\
\centerline{\includegraphics[width=8cm]{./img/Lab_5/X8.jpg}}
\\\\
\textcolor{blue}{Si nota come, al fine di realizzare una cella più compatta, questa sia stata ottenuta attraverso la tecnica dei folded transistors.}
\\\\
...
\\
SIMO: E' possibile notare come i contributi con carichi diversi siano uguali, ma Enea ha detto di concentrarci da un'altra parte.}
\\\\
...
\\
SIMO: Io metterei il rapporto tra fattore di aumento dei ritardi e fattore di riduzione della potenza. Poi si potrebbe fare anche un discorso sul fatto che se stiamo lavorando in un percorso critico non è conveniente rischiare di renderlo critico usando la porta low leakage}
\\\\
\begin{center}
	\begin{tabular}{|c|c|}
	\hline
