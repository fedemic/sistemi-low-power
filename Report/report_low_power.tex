...
\\
Nella transizione da uno stato all'altro il numero di commutazioni è pari alla variazione degli addendi. Ne consegue che il massimo numero di commutazioni durante una transizione è pari a 2.\\
...
\\\\
Si è notato che tali funzioni logiche presentano un'implementazione semplice con un numero limitato di porte. \textcolor{blue}{Di seguito sono riportate le mappe di Karnaugh per le funzioni logiche sopra descritte}
\\\\
...
\\\\
tale valore è stato fissato a 40 uW. Si nota che tale valore è leggermente inferiore rispetto alla potenza dinamica ottenuta nelle prime simulazioni.
\\
