...
\\\\
\centerline{\includegraphics[width=10cm]{./img/Lab_3/datapath_parallelo.jpeg}}
\\\\
...
\centerline{potenza @ 5 MHz = 3 reg + 2 inc + comp + mux + 5 reg (pipe) = 1.86 uW\\}
\centerline{area = 3 reg + 2 inc + comp + mux + 5 reg (pipe) = 3342 um 2\\}
\vspace{0.3cm}
...
\\
Per raggiungere le stesse prestazioni della pipeline in termini di riduzione dei consumi, è necessario introdurre un ulteriore livello di parallelismo: in questo caso è possibile selezionare u = 0.37, ottenendo quindi un consumo di potenza pari a 1.74 uW, leggermente inferiore rispetto al risultato ottenuto con la pipeline.
\\\\
