...
\end{center}
\vspace{0.3cm}
E' possibile notare che il contributo maggiore del consumo è dovuto alle capacità di carico dei nodi in analisi, che assumono  valori significativi. Questo è il principale motivo per cui tali segnali contribuiscono maggiormente, a parità di toggle rate.
