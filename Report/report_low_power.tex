...
\\\\
\centerline{percorso critico = reg + inc + comp + mux = 210 ns\\}
\centerline{frequenza massima = 4.76 MHz\\}
\centerline{potenza @ 2.5 MHz = 2$\cdot$(3 reg + 2 inc + comp + mux) + mux(overhead) = 2.89 uW\\}
