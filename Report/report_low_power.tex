...
\\
\textcolor{red}{Dobbiamo usare questi valori?}
\begin{center}
\begin{listato}
...
\\\\
La prima ipotesi consiste nel considerare la memoria vicina al processore, per esempio una cache, che deve garantire bassi consumi con accessi frequenti. In questo caso è importante minimizzare il contributo di potenza dinamica, in quanto la memoria si troverà raramente in stand by.
\\
