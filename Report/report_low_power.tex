...
\begin{center}
	...
	\hline
	Internal power [uW] & Switching power [uW] & Leakage power [uW] & Total power [uW] \\
	\hline
...
\end{center}
\vspace{0.3cm}
Un'analisi di potenza di tipo net permette di ottenere informazioni più dettagliate sulla statistica dei segnali. In particolare sono riportate le informazioni relative ai segnali di clock, reset, INCA e INCB.
\\
\begin{center}
	\begin{tabular}{|c|c|c|}
	\hline
Segnale & Stati probability & Toggle rate \\
	\hline
	 clock & 0.5  &  0.4 \\
	\hline
	 reset & 0.5  &  0.02 \\
...
\textcolor{red}{Aggiornare dati in tabella}
\\
\begin{center}
	\begin{tabular}{|c|c|c|c|}
	\hline
