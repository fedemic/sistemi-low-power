...
\end{center}
\vspace{0.3cm}}
\textcolor{blue}{Si nota come l'applicazione della codifica BUSINV riduca la potenza dissipata sia per dati che per indirizzi: in quest'ultimo caso i benefici sono particolarmente marcati nel caso di salti frequenti.
\\\\
Al contrario di quanto atteso, la codifica TRAN-BASED non apporta miglioramenti significativi. La causa di tale risultato è da ricercare nella distribuzione dei dati generati: questi presentano infatti un numero di 1 elevato.
\\\\
